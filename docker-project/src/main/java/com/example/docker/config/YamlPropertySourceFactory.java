...
public class YamlPropertySourceFactory implements PropertySourceFactory {
    ...
    public PropertySource<?> createPropertySource(@Nullable String name, EncodedResource resource) throws IOException {
        ...
        return new PropertiesPropertySource(!StringUtils.isEmpty(name) ? name : resource.getResource().getFilename(), loadedProperties);
    }
...
//        }
//
//        return new PropertiesPropertySource((!StringUtils.isEmpty(name)) ? name : resource.getResource().getFilename(), effectiveProperties);
//    }
    ...
    private String[] getActiveRuntimeProfiles() {
        ...
        return StringUtils.isEmpty(profileConfig) ? new String[] {} : profileConfig.split(",");
    }
}